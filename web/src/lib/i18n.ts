...
export const translations = {
  ru: {
    ...
    deleteChatAsk: "Удалить переписку?",
    deleteChatWhy: "Она исчезнет только у вас. У собеседника останется.",
    deleteGroupEveryone: "Удалить группу у всех",
    deleteGroupAsk: "Удалить группу у всех участников? Это нельзя отменить.",
    removeMember: "Исключить",
    removeMemberAsk: "Исключить из группы?",
    ...
    mediaFiles: "Медиа, файлы, ссылки",
    leaveGroup: "Покинуть группу",
    leaveGroupAsk: "Покинуть группу?",
    leaveGroupWhy:
      "Переписка останется на сервере, но вы перестанете получать новые сообщения.",
    leave: "Выйти",
    admin: "Администратор",
    searchInChat: "Поиск по переписке",
    searchInChatHint: "Что искать",
    nothingFound: "Ничего не нашлось",
    inThisChat: "В этой переписке",
  ...
  en: {
    ...
    deleteChatWhy: "It disappears only for you. The other person keeps it.",
    deleteGroupEveryone: "Delete group for everyone",
    deleteGroupAsk: "Delete the group for all members? This cannot be undone.",
    removeMember: "Remove",
    removeMemberAsk: "Remove from the group?",
    ...
    mediaFiles: "Media, files, links",
    leaveGroup: "Leave group",
    leaveGroupAsk: "Leave the group?",
    leaveGroupWhy:
      "The chat stays on the server, but you will stop receiving new messages.",
    cancel: "Cancel",
    leave: "Leave",
    admin: "Admin",
    searchInChat: "Search in chat",
    searchInChatHint: "What to look for",
